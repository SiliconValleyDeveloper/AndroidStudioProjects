...
public class Sorting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<String>(this, R.layout.storing_technique_listview, R.id.textview, data);
...
*/
        lstSearch.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Sorting.this, open_program.class);
                intent.putExtra("Topic", top);
                intent.putExtra("url", "file:///android_asset/tutorial/" + top + ".html");
                Toast.makeText(Sorting.this, top, Toast.LENGTH_SHORT).show();
