...
public class Searching extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<String>(this, R.layout.searching_technique_listview, R.id.textview, data);
...
*/
        lstSearch.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(Searching.this,open_program.class);
                intent.putExtra("Topic", top);
                intent.putExtra("url", "file:///android_asset/tutorial/"+top+".html");
                Toast.makeText(Searching.this,top,Toast.LENGTH_SHORT).show();
