...
public class Start_offline_four extends AppCompatActivity {

    RadioButton rb1,rb2,rb3,rb4;
    RadioGroup rg;
    TextView txtscore,question,TotalQuestion;
    private int score = 0,questionno = 0;
    private offline_start_four mQuestion = new offline_start_four();
  ...
  //  private AdView mAdView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_start_offline_four);
        ...
        rb1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final MediaPlayer mediaPlayer = MediaPlayer.create(Start_offline_four.this,R.raw.button);
                mediaPlayer.start();
                if (questionno <= mqestionlength) {
                    ...
                    AlertDialog.Builder alertdialogbuilder = new AlertDialog.Builder(Start_offline_four.this);
                    ...
                    alertdialogbuilder.setMessage("You've finished the quiz.Try the another SET.!" )
                            ...
                            .setNegativeButton("Try Online Quiz"
                                    , new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            Intent intent = new Intent(Start_offline_four.this, online_login.class);
