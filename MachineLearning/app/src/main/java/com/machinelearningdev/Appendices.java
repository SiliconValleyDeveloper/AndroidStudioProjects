...
public class Appendices extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ArrayAdapter<String>(this, R.layout.appendices_listview, R.id.textview, data);
        listView.setAdapter(adapter);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                final String topic = data[position];
                Intent intent = new Intent(Appendices.this, Open_Appendices.class);
                intent.putExtra("Topic", topic);
                intent.putExtra("url", "file:///android_asset/Appendices/"+topic+".html");
