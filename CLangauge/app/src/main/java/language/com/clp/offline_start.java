...
public class offline_start extends AppCompatActivity {
    ...
    private offline_start_one mQuestion = new offline_start_one();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rb1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final MediaPlayer mediaPlayer = MediaPlayer.create(offline_start.this,R.raw.button);
                mediaPlayer.start();
                if(questionno<mqestionlength) {
                    ...
                    AlertDialog.Builder alertdialogbuilder= new AlertDialog.Builder(offline_start.this);     alertdialogbuilder.setTitle("Congratulations:) ");
                    ...
                    alertdialogbuilder.setMessage("You've finished the quiz.Try the another SET.!" )
                            ...
                            .setNegativeButton("Try Online Quiz"
                                    , new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            Intent intent = new Intent(offline_start.this,online_login.class);
        ...
        rb2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(questionno<mqestionlength) {
                    ...
                    AlertDialog.Builder alertdialogbuilder= new AlertDialog.Builder(offline_start.this);
                    alertdialogbuilder.setTitle("Congratulations");
                    alertdialogbuilder.setIcon(R.drawable.winning);
                    alertdialogbuilder.setMessage("You've finished the quiz.Try the another SET.!" )
                            .setCancelable(false)
